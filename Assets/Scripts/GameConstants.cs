...
{
    public const string KEY_DIET_NAME = "DietName";
    public const string KEY_INTENSITY_NAME = "IntensityName";
    public const string DIET_NAME_STANDART = "Стандартная";
    ...
    public const string INTENSITY_NAME_2_TIMES_TRAINING = "Тренировка 1-2 раз в неделю";
